...
+ (void)setSoloBraceIndentWidthPreference:(NSInteger)arg1;
+ (NSInteger)getSoloBraceIndentWidthPreference;
...
+ (void)setWrappedLineIndentWidthPreference:(NSInteger)arg1;
+ (NSInteger)getWrappedLineIndentWidthPreference;
