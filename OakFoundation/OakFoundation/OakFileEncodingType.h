...
static inline BOOL supports_byte_order_mark (NSString * charset)
{
    NSArray *Encodings = @[ kCharsetUTF8, kCharsetUTF16BE, kCharsetUTF16LE, kCharsetUTF32BE, kCharsetUTF32LE ];
