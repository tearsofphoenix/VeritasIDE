...
- (id)addFiles:(id)arg1 atIndex:(NSInteger)arg2 copy:(BOOL)arg3 createGroupsRecursively:(BOOL)arg4;
...
- (id)_insertRefOfClass:(Class)arg1 withName:(id)arg2 forFile:(id)arg3 ofFileType:(id)arg4 withFileProperties:(id)arg5 atIndex:(NSInteger)arg6;
...
- (int)changeMask;
- (id)createNewGroupAtIndex:(NSUInteger)arg1;
...
- (void)removeFromFileReferencesAtIndex:(NSUInteger)arg1;
- (void)replaceInFileReferences:(id)arg1 atIndex:(NSUInteger)arg2;
- (void)insertInFileReferences:(id)arg1;
- (void)insertInFileReferences:(id)arg1 atIndex:(NSUInteger)arg2;
- (void)removeFromGroupsAtIndex:(NSUInteger)arg1;
- (void)replaceInGroups:(id)arg1 atIndex:(NSUInteger)arg2;
- (void)insertInGroups:(id)arg1;
- (void)insertInGroups:(id)arg1 atIndex:(NSUInteger)arg2;
- (void)removeFromChildrenAtIndex:(NSUInteger)arg1;
- (void)replaceInChildren:(id)arg1 atIndex:(NSUInteger)arg2;
- (void)insertInChildren:(id)arg1;
- (void)insertInChildren:(id)arg1 atIndex:(NSUInteger)arg2;
- (id)valueInChildrenAtIndex:(NSUInteger)arg1;
