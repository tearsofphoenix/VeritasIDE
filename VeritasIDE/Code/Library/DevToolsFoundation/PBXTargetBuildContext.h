...
@interface PBXTargetBuildContext : PBXBuildContext <XCBuildInfoManagers>
{
    ...
    NSUInteger _numDepAnalysisErrors;
    NSUInteger _numDepAnalysisWarnings;
    ...
    NSUInteger _distBuildsParallelTasks;
...
- (NSUInteger)countForBuildFileBaseName:(id)arg1;
...
- (void)defineFileContents:(id)arg1 forAuxiliaryFileAtPath:(id)arg2 withPosixPermissions:(NSUInteger)arg3;
...
- (NSUInteger)numberOfDependencyAnalysisWarnings;
- (NSUInteger)numberOfDependencyAnalysisErrors;
...
- (id)commandWithNumber:(NSUInteger)arg1;
...
- (id)dependencyNodeWithNumber:(NSUInteger)arg1;
- (NSUInteger)numberOfDependencyNodes;
...
- (void)handleFailureInFunction:(id)arg1 fileName:(id)arg2 lineNumber:(NSInteger)arg3 messageFormat:(id)arg4 arguments:(struct __va_list_tag [1])arg5;
- (void)handleFailureInMethod:(SEL)arg1 object:(id)arg2 fileName:(id)arg3 lineNumber:(NSInteger)arg4 messageFormat:(id)arg5 arguments:(struct __va_list_tag [1])arg6;
