...
- (void)moveOutputPath:(id)arg1 toIndex:(NSUInteger)arg2;
- (void)removeFromAppleScriptOutputPathsAtIndex:(NSUInteger)arg1;
- (void)replaceInAppleScriptOutputPaths:(id)arg1 atIndex:(NSUInteger)arg2;
- (void)insertInAppleScriptOutputPaths:(id)arg1;
- (void)insertInAppleScriptOutputPaths:(id)arg1 atIndex:(NSUInteger)arg2;
- (id)valueInAppleScriptOutputPathsAtIndex:(NSUInteger)arg1;
- (id)appleScriptOutputPaths;
- (void)moveInputPath:(id)arg1 toIndex:(NSUInteger)arg2;
- (void)removeFromAppleScriptInputPathsAtIndex:(NSUInteger)arg1;
- (void)replaceInAppleScriptInputPaths:(id)arg1 atIndex:(NSUInteger)arg2;
- (void)insertInAppleScriptInputPaths:(id)arg1;
- (void)insertInAppleScriptInputPaths:(id)arg1 atIndex:(NSUInteger)arg2;
- (id)valueInAppleScriptInputPathsAtIndex:(NSUInteger)arg1;
