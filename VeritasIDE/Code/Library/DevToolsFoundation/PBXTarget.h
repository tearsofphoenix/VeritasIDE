...
+ (void)setDesiredNumberOfParallelBuildSubtasks:(NSUInteger)arg1;
+ (NSUInteger)actualNumberOfParallelBuildSubtasks;
+ (NSUInteger)desiredNumberOfParallelBuildSubtasks;
+ (NSUInteger)bestNumberOfParallelBuildSubtasksForHostMachine;
...
- (void)_insertExecutable:(id)arg1 atIndex:(NSUInteger)arg2;
...
- (id)buildRuleAtIndex:(NSUInteger)arg1;
- (void)moveBuildRule:(id)arg1 toIndex:(NSUInteger)arg2;
- (void)moveBuildRulesFromIndices:(NSUInteger *)arg1 numIndices:(NSUInteger)arg2 toIndex:(NSUInteger)arg3;
- (void)removeBuildRule:(id)arg1;
- (void)removeBuildRuleAtIndex:(NSUInteger)arg1;
- (void)addBuildRule:(id)arg1;
- (void)insertBuildRule:(id)arg1 atIndex:(NSUInteger)arg2;
...
- (BOOL)_upgradeInfoPListFromArchivedObjectVersion:(NSUInteger)arg1;
- (BOOL)_upgradeBuildSettings:(id)arg1 fromArchivedObjectVersion:(NSUInteger)arg2;
