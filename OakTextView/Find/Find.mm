...
- (IBAction)takeFindOptionToToggleFrom:(id)sender
{
	...
	switch(option)
	{
		...
		case find::ignore_case:        [[NSUserDefaults standardUserDefaults] setObject:([[NSUserDefaults standardUserDefaults] boolForKey:kUserDefaultsFindIgnoreCase] ? NO_obj : @YES) forKey:kUserDefaultsFindIgnoreCase]; break;
		case find::full_words:         windowController.findFullWords         = !windowController.findFullWords;         break;
		case find::wrap_around:        [[NSUserDefaults standardUserDefaults] setObject:([[NSUserDefaults standardUserDefaults] boolForKey:kUserDefaultsFindWrapAround] ? NO_obj : @YES) forKey:kUserDefaultsFindWrapAround]; break;
