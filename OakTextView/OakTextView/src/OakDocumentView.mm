...
{
	document::OakDocument * oldDocument = document;
	if(oldDocument)
	{
...
{
	std::multimap<NSString *, OakBundleItem *, text::less_t> grammars;
...
{
	if(OakBundleItem * themeItem = bundles::lookup(to_s(themeUUID)))
	{
